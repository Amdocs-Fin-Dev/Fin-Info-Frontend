...
export class WeekChartComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('weekLineChart') weekLineChart!: ElementRef;
  drawChart = (list: any) => {
    list = this.ChartList;
    ...
    const chart = new google.visualization.LineChart(this.weekLineChart.nativeElement);
  ...
  showAny(){
    console.log( "Nani",this.ChartList.Open );
  }
